 ...
 *	<p><ul>
 *		<li>v19 (25.05.2024): updated for newer APIs and fixed dead Client-ID</li>
 ...
 *  @updatedBy <a href="https://github.com/FlavienJalabert">fjalabert</a>
 *
 */

class Twitch extends WebResourceUrlExtractor {
	final String CLIENT_ID = "t8cod8rlguu55goescbwk29yw3zmym"
	final String CLIENT_ID_API = "kimne78kx3ncx6brgo4mv6wki5h1ko"
	final String OAUTH_TOKEN = "g5kc6bp5pe689oerjgaktlx3wzmpv2"
	final Integer VERSION = 19
	final String VALID_FEED_URL = "^https?://(?:[^\\.]*.)?twitch\\.tv/([a-zA-Z0-9_]+).*\$"
	final String VALID_HLS_VOD_URL = "^https?://(?:[^\\.]*.)?twitch\\.tv/videos/(\\d+)[^\\d]*\$"
	final String TWITCH_HLS_API_PLAYLIST_URL = "https://usher.ttvnw.net/api/channel/hls/%s.m3u8?sig=%s&token=%s&allow_source=true"
	...
	final def reqProps = [ 'Authorization': 'Bearer ' + OAUTH_TOKEN, 'Client-ID': CLIENT_ID ]
	...
	List<WebResourceItem> extractHlsVods(Integer vodId) {
		...
		conn.setRequestProperty('Client-ID', CLIENT_ID_API)
